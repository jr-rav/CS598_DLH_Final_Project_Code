...
if __name__ == '__main__':
  ...
  diagnoses = pd.read_csv(hp.mimic_dir + 'DIAGNOSES_ICD.csv', usecols=dtype.keys(), dtype=dtype, nrows=20000)
  ...
  procedures = pd.read_csv(hp.mimic_dir + 'PROCEDURES_ICD.csv', usecols=dtype.keys(), dtype=dtype, nrows=20000)
